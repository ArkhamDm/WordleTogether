...
class FirestoreRepositoryImpl (
    ...
    override fun addSession(sessionItem: SessionItem): Flow<ResultState<String>> = callbackFlow {
        ...
        // LCLCLCLCLC|
        // LCLCLCLCLC|
        val wordleGrid = Array(StartValues.startWordleWords.tryingWords.size) {
            Array(StartValues.startWordleWords.tryingWords[0].size) { " N" }.joinToString("")
    ...
    override fun updateWord(idSession: String, word: String, isHost: Boolean): Flow<ResultState<String>> =
        callbackFlow {
            trySend(ResultState.Loading)
    ...
    override fun disconnect(idSession: String, isHost: Boolean): Flow<ResultState<String>> =
        callbackFlow {
            trySend(ResultState.Loading)
    ...
    override fun reset(idSession: String, isHost: Boolean): Flow<ResultState<String>> =
        callbackFlow {
            trySend(ResultState.Loading)
