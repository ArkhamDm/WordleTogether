        ...
        Row(
            ...
            for (letter in keyboardLetter[0]) {
                Letter(
                    ...
                    modifier = Modifier
                        .padding(3.dp)
                        .clickable { lettersViewModel.send(LetterEvent.AddLetter(letter.letter, isHost)) }
                        .width(27.dp),
            ...
            Card(
                ...
                Icon(
                    ...
                    modifier = Modifier
                        ...
                        .clickable { lettersViewModel.send(LetterEvent.DeleteLetter(isHost)) }
                )
            }
                    ...
                    modifier = Modifier
                        ...
                        .clickable {
                            if (
                                ...
                                lettersViewModel.send(LetterEvent.CheckAnswer(isHost))
                                changePlayer()
                            } else {
                                isError = !isError
                            }
