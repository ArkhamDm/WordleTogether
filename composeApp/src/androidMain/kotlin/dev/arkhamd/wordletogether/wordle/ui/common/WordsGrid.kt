...
fun Word(
    ...
    Row(
        ...
        for (letter in word) {
            ...
            val transition =
                updateTransition(targetState = letter.feedback, label = "RevertCardTransition")
            ...
            val rotationState by transition.animateFloat(
                ...
                if (it == LetterFeedback.None) 0f else 180f
            }
            ...
            val colorState by transition.animateColor(
                transitionSpec = {
                    keyframes {
                        durationMillis = 1000
                        LetterFeedback.None.toUiColor() at 200 with LinearOutSlowInEasing
                    }
                },
                label = "RevertCardTransition"
            ) {
